...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("bubbleSort.SelectionSort", arr1);
        SortTestHelper.testSort("bubbleSort.InsertionSort", arr2);
        SortTestHelper.testSort("bubbleSort.BubbleSort", arr3);
        SortTestHelper.testSort("bubbleSort.BubbleSort2", arr4);
